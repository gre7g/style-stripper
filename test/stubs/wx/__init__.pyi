...
class Point(object):
    ...
    def __iter__(
        self,
    ) -> Iterator[int]: ...  # it doesn't really have an __iter__ but mypy is confused
...
class TimeSpan(object):
    ...
    def Days(
        days: long,
    ) -> TimeSpan: ...  # Returns the timespan for the given number of days.
    def Format(
        self,
        format: Text = ...,
    ...
    def GetMilliseconds(
        self,
    ) -> long: ...  # Returns the difference in number of milliseconds.
    ...
    def Hours(
        hours: long,
    ) -> TimeSpan: ...  # Returns the timespan for the given number of hours.
    ...
    def Milliseconds(
        ms: long,
    ) -> TimeSpan: ...  # Returns the timespan for the given number of milliseconds.
    ...
    def Minutes(
        min: long,
    ) -> TimeSpan: ...  # Returns the timespan for the given number of minutes.
    ...
    def Seconds(
        sec: long,
    ) -> TimeSpan: ...  # Returns the timespan for the given number of seconds.
    ...
    def Weeks(
        weeks: long,
    ) -> TimeSpan: ...  # Returns the timespan for the given number of weeks.
...
class Window(WindowBase):
    ...
    def SetPosition(self, pt: Union[Point, Tuple[int, int]]) -> None: ...
    def SetRect(
        self,
        rect: RectType,
    ) -> None: ...
...
class MessageDialog(Dialog):
    ...
    def __enter__(self) -> "MessageDialog": ...
    def __exit__(self, exc_type, exc_val, exc_tb) -> bool: ...
...
class TextEntryDialog(Dialog):
    ...
    def __enter__(self) -> "TextEntryDialog": ...
    def __exit__(self, exc_type, exc_val, exc_tb) -> bool: ...
...
class TextCtrl(TextEntry, Control):
    ...
    def HitTest(self, pt: Point) -> Tuple[int, int, int]: ...
    def XYToPosition(self, x: long, y: long) -> long: ...
...
class AcceleratorTable(Object):
    ...
    def __init__(
        ...
        entries: Sequence[
            AcceleratorEntry
        ],  # TODO FIXME: This also supports a Tuple but the documentation isn't clear
    ) -> None: ...
...
def GetTranslation(
    string: str, domain: Optional[str] = ..., context: Optional[str] = ...
) -> str: ...
