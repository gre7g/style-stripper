...
class Enums(Enum):
    ...
    STATE_FIX_DIVIDERS = auto()
    STATE_IDLE = auto()
    STATE_FIX_ELLIPSES = auto()
...
STATE_FIX_DIVIDERS = Enums.STATE_FIX_DIVIDERS
STATE_IDLE = Enums.STATE_IDLE
STATE_FIX_ELLIPSES = Enums.STATE_FIX_ELLIPSES
