...
class OptionsPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        sizer13.Add(self.end, 1, 0, 0)
        sizer14 = wx.BoxSizer(wx.HORIZONTAL)
        sizer11.Add(sizer14, 0, wx.EXPAND | wx.TOP, 10)
        ...
        sizer15.Add(sizer16, 1, wx.EXPAND | wx.ALL, 10)
        ...
        sizer17.Add(self.en_dash_text, 0, 0, 0)
        self.em_dash = wx.RadioButton(box)
        sizer17.Add(self.em_dash, 0, wx.ALIGN_CENTER_VERTICAL, 0)
