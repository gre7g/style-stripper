...
class OptionsPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        sizer1b.Add(self.italic, 1, wx.TOP | wx.LEFT, 10)

        self.quotes = wx.CheckBox(self, label=_("Convert quotes to curly"))
        sizer1b.Add(self.quotes, 1, wx.TOP | wx.LEFT, 10)

        box = wx.StaticBox(self, label=_("Scene breaks"))
        sizer1b.Add(box, 1, wx.EXPAND | wx.TOP, 10)
        ...
        sizer1c.Add(box, 1, wx.EXPAND | wx.TOP, 10)
